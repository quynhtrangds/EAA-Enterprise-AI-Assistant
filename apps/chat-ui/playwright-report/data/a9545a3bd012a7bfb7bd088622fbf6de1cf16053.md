...
- Name: mcp-gateway-flow.spec.ts >> MCP Gateway Flow Sequence E2E >> TC1: Xác minh luồng thành công và Audit Log
- Location: e2e\mcp-gateway-flow.spec.ts:24:3
...
Call log:
  - waiting for locator('button:has-text("Cuộc trò chuyện mới")') to be visible
